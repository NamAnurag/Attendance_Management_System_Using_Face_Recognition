...
def attendanceout():
    ...
    emp_file = pd.read_csv('C:/Users/anura/Downloads/Face_recognition_employee_attendance_system/Face_recognition_employee_attendance_system/attendance/Data_files/Employee_details.csv')
...
# camera will capture 10 images and then we will select middle image to increase accuracy.
    ...
    for i in range(10):
        ...
        cv2.imwrite('C:\\Users\\KIIT\\OneDrive\\Desktop\\Face_recognition_employee_attendance_system\\captured_images\\Employee' +
    ...
    captured_image = face_recognition.load_image_file(
        'C:\\Users\\KIIT\\OneDrive\\Desktop\\Face_recognition_employee_attendance_system\\captured_images\\Employee5.png', 'RGB')
...
# Module 6 Announce Attendance Recorded Module
    ...
    pygame.mixer.init()
    if emp_index == -1:
         playsound("C:\\Users\\KIIT\\OneDrive\\Desktop\\Face_recognition_employee_attendance_system\\attendance\\Data_files\\Employee_audios\\Fnotrecognised.mp3")
    else:
        playsound(audioloc)
